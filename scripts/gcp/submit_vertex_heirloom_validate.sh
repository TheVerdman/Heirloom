    ...
    if require_gpu:
        ...
        if run_qb_data_hardpath:
            ...
            optional_hardpath_names = [
                ...
                "HEIRLOOM_CUDA_KERNEL_LAUNCH_FAMILY_TIMING",
                "HEIRLOOM_CUDA_TENSOR_CORE_GLOBAL_CTA_GEMM",
                "HEIRLOOM_CUDA_TENSOR_CORE_WIDE_SWIZZLED_GEMM",
...
- machineSpec:
  ...
  pythonPackageSpec:
    ...
    - name: HEIRLOOM_CUDA_KERNEL_LAUNCH_FAMILY_TIMING
      value: "${HEIRLOOM_CUDA_KERNEL_LAUNCH_FAMILY_TIMING:-__HEIRLOOM_UNSET__}"
