...
fn write_memory_train_report(input: MemoryTrainReportInput<'_>) -> Result<()> {
    ...
    let memory_kernel_json = serde_json::json!({
        ...
        "product_key_selected_score_forward_calls": input.memory_kernel_counters.product_key_selected_score_forward_calls,
        "product_key_backward_query_calls": input.memory_kernel_counters.product_key_backward_query_calls,
        "product_key_backward_half_key_calls": input.memory_kernel_counters.product_key_backward_half_key_calls,
